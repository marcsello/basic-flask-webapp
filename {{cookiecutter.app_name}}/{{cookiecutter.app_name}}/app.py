...
# configure flask app
{% if cookiecutter.use_sqlalchemy == 'y' %}app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URI', "sqlite://")  # Default to memory db
{% endif %}
...
{% if cookiecutter.use_sqlalchemy == 'y' %}# disable this for better performance
